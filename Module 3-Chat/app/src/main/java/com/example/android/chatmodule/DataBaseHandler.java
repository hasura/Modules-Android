...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public UserDetails getProfile(){
        ...
        String selectProfileQuery = "SELECT NAME, STATUS, PICTURE, ID FROM " + TABLE_USER + " WHERE ( ID = " + user.getId() + ")";
        ...
        if(cursor.moveToFirst()){
            ...
            userDetails.setId(cursor.getInt(2));
        }
